document.addEventListener('DOMContentLoaded', () => {
    ...
    const lines = [
        { id: 1, name: "Línea 100", description: "Descripción detallada de la línea de soporte y atención. Enfocada en casos graves.", number: "100", contactType: "tel", contactLink: "100", icon: "linea 100.png" },
        { id: 2, name: "Chat 105", description: "Chat de soporte y asesoría confidencial para situaciones de violencia. Para iniciar el chat.", number: "105", contactType: "chat", contactLink: "https://ejemplo.com/chat", icon: "105.png" },
        { id: 3, name: "Policía Nacional", description: "Línea de emergencia y denuncia para reportar actos delictivos.", number: "101", contactType: "tel", contactLink: "101", icon: "policia.png" },
        { id: 4, name: "Atención a la Mujer", description: "Asesoría legal y psicológica especializada en casos de violencia de género.", number: "102", contactType: "tel", contactLink: "102", icon: "atencion a la mujer.png" },
    ];
   ...
   function createCardElement(line, isFavorite) {
    ...
    card.innerHTML = `
        <div class="card-avatar">
            <img src="icons/${line.icon || 'avatar.png'}" alt="Icono de Contacto">
        </div>
    ...
    window.filterDirectory = function() {
        ...
        lines.forEach(line => {
            ...
            const matchesSearch = line.name.toLowerCase().includes(searchText) || 
